...
namespace KoiCareSys.MVCWebApp.Controllers
{
    public class OrderDetailsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,ProductId,OrderId,Quantity,Subtotal,CreateDate,UpdateDate")] OrderDetail orderDetail)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Id,ProductId,OrderId,Quantity,Subtotal,CreateDate,UpdateDate")] OrderDetail orderDetail)
        {
