...
//        => optionsBuilder.UseSqlServer("Data Source=DUNGPHAM;Initial Catalog=KoiCareDb;User ID=sa;Password=123456;Connect Timeout=30;Encrypt=True;Trust Server Certificate=True;Application Intent=ReadWrite;Multi Subnet Failover=False");
...
//            entity.HasOne(d => d.Pond).WithMany(p => p.FeedingSchedules).HasForeignKey(d => d.PondId);
//        });
...
//            entity.Property(e => e.HealthIssue).HasColumnName("health_issue");
...
//        {
//            entity.ToTable("order_detail", "koicare");
...
//        {
//            entity.ToTable("product", "koicare");
